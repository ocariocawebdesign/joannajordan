              ...
              <div className="row">
                ...
                >
                  <div className="box-1 box-content_primary_1 ">
                    ...
                    <h1 className="text-center name-title-header">
                      Urban Style
                    </h1>
                    ...
                    <div className="row">
                      ...
                      <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6 sobre">
                        <p className="text-left name-title-header animate__animated animate__backInRight">
                          Lorem ipsum dolor sit amet, consectetur adipiscing
                          elit. Vestibulum et gravida eros. Nunc eleifend eros
                          enim, lacinia malesuada sem porta quis. Aliquam
                          scelerisque ac magna vitae ultricies. Sed ut erat
                          faucibus urna ultricies fermentum. Nam tincidunt
                          tortor ut est fringilla, eget sodales erat venenatis.
                          Integer maximus ipsum ipsum, in vulputate dui lobortis
                          at. Praesent luctus diam eget malesuada aliquet. Etiam
                          scelerisque feugiat ultrices.
                        </p>
                        <br />
                      </div>
                    </div>
